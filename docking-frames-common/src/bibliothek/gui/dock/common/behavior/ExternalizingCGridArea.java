...
@Todo(priority=Priority.MAJOR, target=Version.VERSION_1_1_2, compatibility=Compatibility.COMPATIBLE,
        description="The 'unmaximize' button appears at the wrong location. "
                + "And during drag and drop layout information is lost due to "
                + "the listener that inserts the station after the dockable "
                + "was inserted. Also perspectives will not yet work.")
