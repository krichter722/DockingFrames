...
public class BubbleButtonDockTitle extends AbstractBubbleDockTitle{
    ...
    private void initAnimation(){
        ...
        addConditionalFont( DockFont.ID_FLAP_BUTTON_ACTIVE,
        ...
        addConditionalFont( DockFont.ID_FLAP_BUTTON_SELECTED,
                TitleFont.KIND_FLAP_BUTTON_FONT,
                new Condition(){
                    public boolean getState() {
                        return isSelected();
        ...
        addConditionalFont( DockFont.ID_FLAP_BUTTON_INACTIVE,
                TitleFont.KIND_FLAP_BUTTON_FONT,
                new Condition(){
                    public boolean getState() {
                        return !isActive();
    ...
    protected Insets getInnerInsets(){
        ...
        if( behavior.isShowKnob() ){
            if( getOrientation().isHorizontal() ){
                base = new Insets( base.top, base.left + knobSize, base.bottom, base.right );
            }
            else{
                base = new Insets( base.top + knobSize, base.left, base.bottom, base.right );
            }
        }
